<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"F:\www\practice_tp\think\public/../application/admin\view\admin\edit.html";i:1505642560;s:73:"F:\www\practice_tp\think\public/../application/admin\view\common\top.html";i:1506518360;s:74:"F:\www\practice_tp\think\public/../application/admin\view\common\left.html";i:1506428340;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">管理员密码</label>
														<div class="col-sm-6">
                                <input class="form-control" id="password" placeholder="" name="password" value="<?php echo $admins['password']; ?>" type="text">
                            </div>
